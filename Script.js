document.addEventListener('DOMContentLoaded', () => {
    // ================== CONFIGURAÇÕES ==================
    // ⚠️ ATENÇÃO: Substitua pela nova URL do Google Apps Script após reimplantação
    const BACKEND_URL = "https://script.google.com/macros/s/AKfycbwTVSWe2kCRjrHbHd04BAjcjEsTa_wweJkEjM9XVdEAHUnwgRw3owPEgf833DuSLvrrfA/exec";
    ...
    function iniciarBot(dadosAtendente) {
        ...
        function addMessage(message, sender, options = {}) {
            ...
            if (sender === 'bot') {
                ...
                positiveBtn.onclick = () => enviarFeedback('logFeedbackPositivo', feedbackContainer, sourceRow);
                const negativeBtn = document.createElement('button');
                negativeBtn.className = 'feedback-btn';
                negativeBtn.innerHTML = '👎';
                negativeBtn.title = 'Resposta incorreta';
                negativeBtn.onclick = () => enviarFeedback('logFeedbackNegativo', feedbackContainer, sourceRow);
        ...
        // Enviar feedback
        async function enviarFeedback(action, container, sourceRow) {
